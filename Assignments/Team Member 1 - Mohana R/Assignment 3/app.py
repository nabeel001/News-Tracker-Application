...
COS_API_KEY_ID="NRM3OXQnqQZC7GV_hUNRx3b-wWuVMW7msvBu-OIqC1f1"
COS_INSTANCE_CRN="crn:v1:bluemix:public:iam-identity::a/a6aa805ee4114d22b28d73fa64b79bee::serviceid:ServiceId-5d365de3-d246-4acd-bdac-8a2849f48128"
...
@app.route('/')
def index():
    files = get_bucket_contents('ssnce195002073')
